  ...
  return (
    <>
      <View style={styles.authComponentRegister}>
        <Text style={styles.authComponentRegister_title}>Name</Text>
        <View style={styles.authComponentRegister_content}>
            <User size='20' color='black' style={{marginVertical: 8}} />
            <TextInput style={styles.authComponentRegister_componentInput} placeholder='Full Name' placeholderTextColor='black' value={name} onChangeText={text => setName(text)} autoCapitalize='none' />
        </View>
      </View>
      <View style={styles.authComponentRegister}>
        <Text style={styles.authComponentRegister_title}>Identification</Text>
        <View style={styles.authComponentRegister_content}>
            <Hashtag size='20' color='black' style={{marginVertical: 8}} />
            <TextInput style={styles.authComponentRegister_componentInput} placeholder='Identification number' placeholderTextColor='black' value={identification} onChangeText={text => setIdentification(text)} autoCapitalize='none' />
        </View>
      </View>
      <View style={styles.authComponentRegister}>
        ...
        <View style={styles.authComponentRegister_content}>
            ...
            <TextInput style={styles.authComponentRegister_componentInput} placeholder='Email' placeholderTextColor='black' value={email} onChangeText={text => setEmail(text)} autoCapitalize='none' />
        </View>
      </View>
      <View style={styles.authComponentRegister}>
        <Text style={styles.authComponentRegister_title}>Password</Text>
        <View style={styles.authComponentRegister_content}>
      ...
      <View style={styles.authComponentRegister}>
        <Text style={styles.authComponentRegister_title}>Repeat Password</Text>
        <View style={styles.authComponentRegister_content}>
            <PasswordCheck size='20' color='black' style={{marginVertical: 8}} />
      ...
      <View style={styles.authComponentRegister_buttonContent}>
            <TouchableOpacity style={styles.authComponentRegister_button} onPress={buttonRegister}>
                <Text style={styles.authComponentRegister_buttonTitle}>Register</Text>
            </TouchableOpacity>
        </View>
    </>
  )
