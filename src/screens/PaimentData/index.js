...
const PaimentData = ({ route, ...props }) => {
  ...
  console.log(route.params?.price, "SS")
    ...
    useEffect(()=>{
      axios.get(`https://sandbox.wompi.co/v1/merchants/pub_test_jDc8Fwgxbbr1shC1Qc12kUL9bcVlR3xh`).then(function (response) {
    ...
    const payCobertura = (values) => {
      ...
      axios.post(`https://sandbox.wompi.co/v1/tokens/cards`, data_card, config).then(function (response) {
