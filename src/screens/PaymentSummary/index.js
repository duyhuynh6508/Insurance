...
function Index(props){
    ...
    function GotoPay() { 
      ...
      // return false
        ...
        const config = {
            headers: {
              "Authorization": `Bearer pub_test_jDc8Fwgxbbr1shC1Qc12kUL9bcVlR3xh`,
            }
        }
        ...
        axios.post(`https://sandbox.wompi.co/v1/transactions`, data, config).then(function (response) {
    ...
    function verifyTransaction(){
      ...
      console.log(`https://sandbox.wompi.co/v1/transactions/${IdTransaction}`)
      axios.get(`https://sandbox.wompi.co/v1/transactions/${IdTransaction}`).then(function (response) {
          ...
          verifyTransaction()
            ...
            if(response.data.data.status == "APPROVED"){
              console.log(response.data.data.status, "STATUS DE TRANSAACCION")
                ...
                return (axios.post(`https://blindaje.pdtcomunicaciones.com/api/cobertura/register`, {
